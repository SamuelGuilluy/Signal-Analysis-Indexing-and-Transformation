...
class MusicNet(data.Dataset):
    ...
    def __init__(self, root, train=True, download=True, refresh_cache=False, mmap=False, normalize=True, window=16384, pitch_shift=0, jitter=0., epoch_size=100000):
        ...
        #print(self.labels[1728])
        self.records = dict()
        self.open_files = []

    def __enter__(self):
        # print("__enter__ launch")
